...
class ZhCn
{
    ...
    public $error_templates = [
        ...
        'date:invalid_format:@p1' => '@this 格式 @p1 不是合法的时间格式',
        'date:invalid_format:@p2' => '@this 格式 @p2 不是合法的时间格式',
        'date:invalid_format:@p3' => '@this 格式 @p3 不是合法的时间格式',
        'date=' => '@this 时间必须等于 @p1',
        'date!=' => '@this 时间必须不等于 @p1',
        'date>' => '@this 时间必须大于 @p1',
        'date>=' => '@this 时间必须大于等于 @p1',
        'date<' => '@this 时间必须小于 @p1',
        'date<=' => '@this 时间必须小于等于 @p1',
        'date><' => '@this 时间必须大于 @p1 且小于 @p2',
        'date>=<' => '@this 时间必须大于等于 @p1 且小于 @p2',
        'date><=' => '@this 时间必须大于 @p1 且小于等于 @p2',
        'date>=<=' => '@this 时间必须在 @p1 和 @p2 之间',
    ];
}
